...
dependencies {
  ...
  //  implementation(project(":analytics_module"))
    ...
    androidTestImplementation("androidx.compose.ui:ui-test-junit4:1.5.1") // Or your Compose version

    // Needed for createAndroidComposeRule (ActivityScenario):
    androidTestImplementation("androidx.test.ext:junit:1.1.5")
    androidTestImplementation("androidx.test.espresso:espresso-core:3.5.1")

    // Needed for verify assertions like assertIsDisplayed
